...
Remember that your use of Granola, Inc.'s Services is at all times subject to the [Terms of Use](/tos), which incorporates this Copyright Dispute Policy. Any terms we use in this Policy without defining them have the definitions given to them in the [Terms of Use](/tos).
