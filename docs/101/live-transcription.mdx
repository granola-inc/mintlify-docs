...
For a calendar event, Granola begins transcribing only when you have opened a set of meeting notes, and only from the start time of the calendar event. You can choose to begin transcription manually if you want to begin it earlier. &#x20;
