...
Granola currently runs on Mac, with an iOS app in development. While we don't have specific release dates, we maintain a [waitlist for the Windows version](https://tally.so/r/3EXKgL?utm_source=email%2Cweb). If you join the waitlist, you will be the first to hear when we are building functionality for Windows. You can stay updated on new platform releases through:
...
* Visit the [Granola website](https://granola.so/) and click Download Granola for Mac. (Granola isn't yet available on Windows, [join the waitlist](https://tally.so/r/3EXKgL?utm_source=email%2Cweb) to be the first to hear when we are.)

![Download Granola](/images/downloadimage.png)
...
<AccordionGroup>
  ...
  <Accordion title="I left my company; can I move my existing notes to a new email?">
    <p>Currently, we do not have a built-in "transfer notes" feature. If you are a paid subscriber to an Individual plan, we'll do our best to assist in manually migrating your notes.</p>
  </Accordion>
</AccordionGroup>
