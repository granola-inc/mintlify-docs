...
<Info>
  &#x20;For Outlook users, we provide a [**workaround**](/docs/101/21Outlookintegration) that involves linking your Outlook calendar to Google Calendar. The success of this workaround depends on your organization's IT policies – some companies may restrict calendar sharing between platforms.figjam
</Info>
